...
$(document).ready(function() {
	...
	// <button class="next">stage3</button>을 클릭하면 게임 시작
...
function startGame(callBack) { 
	...
	/* 난이도 선택 디버그 - 난이도 선택이 메인 화면에서 가능해지면 삭제 예정 */
	let debugLevel = prompt("[난이도 디버그]: 난이도를 (1, 2, 3)중 고르시오. (범위 밖이면 자동 1)");
	switch(debugLevel) {
		case "2":
			currentLevel = "normal";
			break;
	...
	// 공 객체
	let ball = new Ball(450, 600, 10, 10, levelInfo.ball_speed + 6);
